...
完整的模型列表请访问：https://moark.com/docs/products/apis
...
2. 确认 API Key 在 https://moark.com/dashboard/settings/tokens 是有效的
...
**解决方案**：
1. 访问 https://moark.com/docs/products/apis 确认模型名称
2. 确保模型名称拼写正确
3. 检查您的账号是否有权限访问该模型
...
4. **监控使用情况**：在 https://moark.com 查看使用日志
   - 了解模型调用频率
   - 优化成本和性能

## 相关文档

- [Gitee AI 模型广场文档](https://moark.com/docs/products/apis)
- [快速开始指南](快速开始.md)
- [RAG 使用指南](RAG%20%28检索增强生成%29%20使用指南.md)
- [API 参考](API 参考文档.md)
